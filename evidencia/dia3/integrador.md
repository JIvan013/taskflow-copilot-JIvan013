...
"method": "create",
  "owner": "JIvan013",
  "repo": "taskflow-copilot-JIvan013",
...
```
MCP server 'github-mcp-server': failed to create issue: POST https://api.github.com/repos/JIvan013/taskflow-copilot-JIvan013/issues: 404 Not Found []
```
...
```json
{
  "message": "No se pudo crear el issue: el repositorio JIvan013/taskflow-copilot-JIvan013-cloud no existe. ¿Dónde crear los issues? Elige una opción o indica otra repo completa (owner/repo):",
  "requestedSchema": {
    "properties": {
      "choice": {
        "type": "string",
        ...
        "oneOf": [
          {
            ...
            "title": "Usar repo existente: JIvan013/taskflow-copilot-JIvan013"
          },
          {
            "const": "other",
...
```json
{
  "message": "El repo destino no existe. ¿Usar repo existente local (JIvan013/taskflow-copilot-JIvan013) o indicar otro owner/repo?",
  "requestedSchema": {
    "properties": {
      "repo_choice": {
        "type": "string",
        ...
        "oneOf": [
          {
            "const": "existing",
            "title": "Usar JIvan013/taskflow-copilot-JIvan013"
          },
          {
            "const": "other",
            "title": "Otra repo (escribir owner/repo)"
...
```
User responded: repo_choice=existing, other_repo=crea el issue en el repo existente local JIvan013/taskflow-copilot-JIvan013
```
...
```
{"id":"5491425178","url":"https://github.com/JIvan013/taskflow-copilot-JIvan013/issues/<NUMERO>"}
```
...
He consultado TaskFlow y creado 1 issue en JIvan013/taskflow-copilot-JIvan013:

- Tarea vencida #7: Corregir bug de fechas — https://github.com/JIvan013/taskflow-copilot-JIvan013/issues/4
